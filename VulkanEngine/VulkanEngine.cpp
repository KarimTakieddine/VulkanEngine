...
int main()
{
...
#ifdef _DEBUG
	enabledLayerNames.push_back("VK_LAYER_LUNARG_api_dump");
	enabledLayerNames.push_back("VK_LAYER_LUNARG_core_validation");
	enabledLayerNames.push_back("VK_LAYER_LUNARG_parameter_validation");
#endif
	...
	engineApplication.initializeContext
	(
		"VulkanApplication",
		"VulkanEngine",
		enabledLayerNames,
	...
	engineApplication.initializeWindow
	(
		"Vulkan Window",
		640,
		480
	...
	//char const * _enabledLayerNames[3] =
	//{
	...
	//instanceCreateInfo.ppEnabledLayerNames		= _enabledLayerNames;
	...
	//int deviceQueueFamilyIndex = DeviceQueue::getFamilyIndexMatching(1, VK_QUEUE_TRANSFER_BIT, physicalDevice);
